...
App.controller('FlotChartController', ['$scope', 'ChartData', '$timeout', function($scope, ChartData, $timeout) {
  ...
  // Custom charts
  // ----------------------------------- 
  $scope.acceleroMeterData = ChartData.load('server/chart/accelerometer.json'); // accelerometer - gravitational pull 
  $scope.orientationData = ChartData.load('server/chart/gyroscope.json');  // tilt direction

  $scope.positionData = ChartData.load('server/chart/translational-pos.json'); // moving location
  $scope.velocityData = ChartData.load('server/chart/rvelocity.json'); // rotational velocity (change per second)
  $scope.accelerationData = ChartData.load('server/chart/racceleration.json'); // rotational accelation/movement 
  

  $scope.splineDataOptions = {
      series: {
          lines: {
              show: false
          },
